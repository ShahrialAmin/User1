...
export default defineConfig(({ mode }) => {
  ...
  return {
    plugins: [
      // React plugin (handles HMR automatically)
      react(),
      ...
      // Bundle analyzer (only when running with --mode analyze)
      isAnalyze &&
        visualizer({
          open: true,
      ...
      rollupOptions: {
        ...
        output: {
          ...
          assetFileNames(assetInfo) {
            ...
            if (/woff2?|ttf|otf/i.test(ext)) return 'assets/fonts/[name]-[hash][extname]';
